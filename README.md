...
- **It runs out of memory** - ThreadSanitizer typically increases an application's memory usage by about 5x to 10x this would make it so most real world applictions would blow past the 4GB wasm32 memory limit limiting the usefulness.
